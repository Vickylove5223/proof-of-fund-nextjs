...
Sponsored files need the sponsor's statements, income proof, and a [formal sponsorship letter](/guides/sponsorship-letter-for-visa-from-nigeria-format-and-samples) with relationship evidence. The statements face the same reading as anywhere: consistency over size, and [no unexplained lump sums](/guides/funds-parking-why-large-unexplained-deposits-get-nigerian-visas-refused).

A realistic first-year total: **₦8m–₦15m** including tuition — a fraction of the [Canada/UK/Australia tier](/guides/countries-with-the-lowest-proof-of-funds-requirements-for-student-visas-2026).
...
*   Host invitation where applicable — hosted stays follow the [invitation letter format](/guides/sponsorship-letter-for-visa-from-nigeria-format-and-samples) plus the host's SA ID/permit copy
