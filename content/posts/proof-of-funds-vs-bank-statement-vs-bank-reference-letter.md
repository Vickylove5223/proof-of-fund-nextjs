---
title: 'Proof of Funds vs Bank Statement vs Bank Reference Letter: What''s the Difference?'
...
This is a letter on the bank's letterhead, signed by authorised officers, confirming:

*   You hold an account (with the opening date — account age matters)
...
*   Submitting a statement when the checklist said "bank letter" (or vice versa) — read the checklist literally
