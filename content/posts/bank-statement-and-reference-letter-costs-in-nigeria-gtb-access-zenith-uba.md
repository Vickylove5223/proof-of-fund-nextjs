---
title: 'Bank Statement & Reference Letter Costs in Nigeria: GTB, Access, Zenith, UBA, First Bank'
...
Here is the practical rundown for Nigeria's major banks in 2026, plus the requests that trip people up at the branch.

## Quick Reference: Typical Costs and Timelines

Fees vary slightly by branch and account type — treat these as the ranges you'll actually meet, and confirm at your branch:

| Bank | Stamped statement | Reference/attestation letter | Typical turnaround |
| --- | --- | --- | --- |
...
VAT may be added, and some branches price statements per page or per year covered. Six months of history for an embassy file usually lands **under ₦5,000 total** — the cost is trivial; the queue time is the real tax.

## How to Request Each Document
...
## Five Branch-Level Problems (and Fixes)

1. **"Come back in a week."** Escalate politely to customer service with your embassy appointment date — most banks expedite for travel deadlines.
