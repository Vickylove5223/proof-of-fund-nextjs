...
You must show you have enough to cover these living costs for a maximum of nine months. This means you’ll need either £12,006 (9 x £1,334) for London or £9,207 (9 x £1,023) for outside London, in addition to your tuition fees.

### A Quick Sample Calculation

Let’s say your tuition for the first year is £15,000 and your university is in Manchester (outside London). Here’s how you calculate your required funds:
...
The most common [acceptable proof of funds](/what-is-acceptable-proof-of-funds) include:
...
It’s also crucial to understand the [best narration for proof of funds](/12-best-narration-for-proof-of-funds-in-nigeria) to ensure your transactions are clearly explained and don’t raise red flags.
...
This is where many applicants make mistakes. Pay close attention to these details:

*   **The 28-Day Rule:** The total required funds must be in the account for a minimum of 28 consecutive days. The balance must not drop below the required amount at any point during this period.
*   **Currency Conversion:** Your funds will likely be in Naira (NGN). You must convert the closing balance to Pound Sterling (GBP) on your application. Use the official exchange rate on the [OANDA currency converter](https://www.oanda.com/currency-converter/en/) on the date you submit your application.
*   **Document Format:** Bank statements must show the bank’s name and logo, your name, the account number, and all transactions over the period.
...
*   **‘Funds Parking’:** A large, recent deposit into your account just before the 28-day period begins can look suspicious. This is a major reason [why visa applications get rejected because of POF](/why-visa-applications-get-rejected-because-of-pof-learn-how-to-avoid-it).
*   **Incorrect Documentation:** Submitting statements from a business account or using a non-approved financial institution. For more details, read about [common mistakes in 28-day proof of funds for UK visas](/common-mistakes-in-28-day-proof-of-funds-for-uk-visas-and-how-to-avoid-them).
...
We offer [urgent 48-hour proof of funds](/48-hour-proof-of-funds-uk-student-visa) for those on a tight deadline.
