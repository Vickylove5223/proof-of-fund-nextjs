...
export default function PostIntroCTA() {
  return (
    <div className="bg-[#2E1499]/5 border border-[#2E1499]/10 rounded-2xl p-6 md:p-8 mb-10 text-[#120E00]">
      ...
      <p className="text-lg leading-relaxed mb-8">
        That's where <strong>POF NG</strong> comes in. We provide <strong>legitimate, verifiable Proof of Fund and investment certificate documents</strong> tailored to your specific needs:
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <a 
          ...
          className="bg-[#25D366] text-white font-bold py-3 px-6 rounded-full flex items-center justify-center gap-2 hover:bg-[#20b958] transition-colors"
        >
        ...
        <Link 
          ...
          className="inline-flex items-center justify-center gap-2 border-2 border-[#2E1499] text-[#2E1499] font-bold py-3.5 px-6 rounded-xl hover:bg-[#2E1499]/5 transition-colors"
        >
          See Requirements
          <ArrowRight size={18} />
        </Link>
